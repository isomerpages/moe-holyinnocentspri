...
.tg .tg-4hv5{background-color:#FFF;border-color:inherit;color:#B00010;font-weight:bold;text-align:left;vertical-align:top}
</style>
<table class="tg">
<thead>
  <tr>
    <th class="tg-xuo2"><span style="color:#666;background-color:#DDD">STAFF DEVELOPMENT</span></th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-4hv5"><a href="mailto:chu_sing_ee@moe.edu.sg">Mdm Chu Sing Ee</a> (Covering)<br><br><span style="background-color:transparent">School Staff Developer</span></td>
  </tr>
</tbody>
</table>